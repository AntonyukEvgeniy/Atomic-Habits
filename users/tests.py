...
class TokenTests(APITestCase):
    def setUp(self):
        ...
        self.valid_credentials = {"username": "testuser", "password": "testpass123"}

    def test_obtain_token(self):
        """Тест получения токена"""
        response = self.client.post(
            self.token_url, self.valid_credentials, format="json"
        )
    ...
    def test_invalid_credentials(self):
        ...
        invalid_credentials = {"username": "testuser", "password": "wrongpass123"}
